...
function () {
  ...
  _createClass(CommentsDb, [{
    ...
    value: function getUserMes(user) {
      this.state.beforeLogin = "\u8C22\u8C22\u4F60\u7684\u7559\u8A00:".concat(user.nickName, "~~~~ ");
    ...
    value: function submitComment() {
      ...
      var db, user;
      return regeneratorRuntime.async(function submitComment$(_context) {
        while (1) {
    ...
    value: function delComment(_id) {
      ...
      var db;
      return regeneratorRuntime.async(function delComment$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              db = _context3.sent;
              db.collection('comments').doc(_id).remove().then(function () {
                _this4.getComment();
              });
    ...
    value: function rebackComment(_id) {
      ...
      return regeneratorRuntime.async(function rebackComment$(_context4) {
        while (1) {
            ...
            case 0:
              ...
              this.auth.getLoginState().then(function (loginstate) {
                if (loginstate) {
                  ...
                  db.collection('comments').doc(_id).get().then(function (res) {
                    _this5.state.rebackPersonId = res.data[0]._id;
                    _this5.state.rebackPersonName = res.data[0].nickname;
                  });
                } else {
                  alert('请先登录');
                }
    ...
    value: function sureComment() {
      ...
      var user;
      return regeneratorRuntime.async(function sureComment$(_context5) {
        while (1) {
    ...
    value: function delMineComment(i, _id) {
      ...
      var db;
      return regeneratorRuntime.async(function delMineComment$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 2:
              db = _context7.sent;
              this.state.isLoading = true;
              db.collection("comments").doc(_id).get().then(function _callee(res) {
                var result;
                return regeneratorRuntime.async(function _callee$(_context6) {
                  while (1) {
                    switch (_context6.prev = _context6.next) {
                      case 0:
                        _context6.next = 2;
                        return regeneratorRuntime.awrap(res.data[0].otherPersonComments);

                      case 2:
                        result = _context6.sent;
                        result.splice(i, 1);

                        _this7.app.callFunction({
                          name: "delMineComment",
                          data: {
                            _id: _id,
    ...
    value: function outlogin() {
      ...
      return regeneratorRuntime.async(function outlogin$(_context8) {
        while (1) {
    ...
    value: function signUp() {
      ...
      return regeneratorRuntime.async(function signUp$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              this.auth.signInWithEmailAndPassword(this.state.email, this.state.password).then(function (loginstate) {
                if (loginstate) {
                  var user = _this9.auth.currentUser;
                  _this9.state.isLoading = false;
                  _this9.state.isLoginBox = false;
                  _this9.state.beforeLogin = "\u8C22\u8C22\u60A8\u7684\u7559\u8A00".concat(user.nickName);
