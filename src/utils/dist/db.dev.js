  ...
  _createClass(Database, [{
    ...
    value: function addUsers() {
      ...
      this.db.collection('register').where({
        ...
        if (res.data.length !== 0) {
          ...
          _this.db.collection('register').add({
    ...
    value: function userLogin() {
      ...
      this.db.collection('register').where({
        ...
        if (res.data.length != 0) {
          _this2.db.collection('register').where({
    ...
    value: function getMes() {
      ...
      this.db.collection('register').doc(this.state.id).get().then(function (res) {
        ...
        if (!file) {
          ...
          this.app.uploadFile({
            ...
            _this6.app.getTempFileURL({
              ...
              _this6.db.collection('center').add({
                ID: id,
                text: text,
